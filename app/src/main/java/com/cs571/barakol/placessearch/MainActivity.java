...
//        mViewPager.setAdapter(mSectionsPagerAdapter);
        ...
        tabLayout.getTabAt(1).setIcon(R.drawable.fav_icon);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FavTab(), "FAVORITES");
    ...
    class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        private int imageResId[] = {R.drawable.search_icon,R.drawable.fav_icon};
...
//            return mFragmentTitleList.get(position);
    ...
    public void onRadioButtonClicked(View view){
        ...
        Log.i("MYERR", Integer.toString(view.getId()));
        Log.i("MYERR", view.toString());
        switch(view.getId()){
            case R.id.from_here:
                if(checked){
                    AutoCompleteTextView searchPlace = findViewById(R.id.locTextView);
